...
| --- | --- | --- | --- |
| containerId | String | n/a | ID of the HTML element that will act as a container for facets |
| field | String | n/a | A numeric custom field to build range. E.g. custom_fields.price |
| maxNumberOfRangeBuckets | integer | 5 | Maximum number of buckets that will be displayed. If a bucket gets 0 count, it will be hidden |
